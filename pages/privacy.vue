<template>
  ...
  >
    ...
    >
      <div justify-center>
        <section-large class="mt-5" :name="'プライバシーポリシー'" />
        <div class="mt-5">
          ...
          <h2>第2条（個人情報の収集方法）</h2>
          <p>本サービスは，ユーザーが利用登録をする際に氏名，生年月日，電話番号，メールアドレスなどの個人情報をお尋ねすることがあります。また，ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を,本サービスの提携先（情報提供元，広告主，広告配信先などを含みます。以下，｢提携先｣といいます。）などから収集することがあります。</p>
          ...
          <p>Eメールアドレス： wish929wish@gmail.com</p>
